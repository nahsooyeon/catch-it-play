...
const GameInfoWidget: FunctionComponent = () => {
	...
	return <div className={"bg-primary gap-4 lg:gap-11 px-5 lg:px-10 py-5 w-full flex"}>
		<div className={"flex flex-col gap-1 items-center justify-center"}>
			<div
				className={"lg:size-20 size-5 p-5 bg-white shadow-bottom rounded-2xl flex items-center justify-center"}>
		...
		<div className={"flex w-full flex-grow  flex-col gap-1 items-center justify-center"}>
			<div
				className={"lg:size-20 h-5 w-full shadow-bottom flex-grow bg-white p-5 rounded-2xl flex items-center justify-end"}>
