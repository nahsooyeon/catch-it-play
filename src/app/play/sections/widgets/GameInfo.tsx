...
const GameInfoWidget: FunctionComponent = () => {
	/* TODO: Context API or zustand store 로 점수 및 레벨에 접근 */
	return <div className={"bg-[#67939F] gap-4 md:gap-11 px-5 md:px-[52px] py-[38px] w-full flex"}>
		<div className={"flex flex-col gap-1 items-center justify-center"}>
			<div
				...
				<span className={"text-black text-3xl leading-6 font-normal text-center"}>{1}</span>
			</div>
		...
		<div className={"flex w-full flex-grow  flex-col gap-1 items-center justify-center"}>
			<div
				...
				<div className={"text-black text-4xl leading-6 font-normal text-right"}>{(10000).toLocaleString()}</div>
			</div>
